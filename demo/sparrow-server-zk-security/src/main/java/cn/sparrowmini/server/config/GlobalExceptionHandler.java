...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<String> handleAccessDenied(DenyPermissionException ex) {
	...
	public ResponseEntity<String> handleTransactionSystemException(TransactionSystemException ex) {
		...
		if (root instanceof DenyPermissionException denyEx) {
			return ResponseEntity.status(HttpStatus.FORBIDDEN).body(denyEx.getMessage());
		}
